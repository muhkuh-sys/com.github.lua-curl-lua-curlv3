...
node {
    def ARTIFACTS_PATH = 'build/*/lua5.*/lua-curlv3/targets/jonchki/repository/com/github/lua-curl/lua-curlv3/*'
        ...
        stage(atEntry[0]){
            docker.image("${atEntry[2]}").inside('-u root') {
                ...
                checkout([$class: 'GitSCM',
                    ...
                    submoduleCfg: [],
                    userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/com.github.lua-curl-lua-curlv3.git']]
                ])
