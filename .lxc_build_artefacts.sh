...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/com.github.lua-curl-lua*-lua-curlv3/targets/jonchki/repository/com/github/lua-curl/lua-curlv3/*" -type f'`
echo ${FILELIST}
