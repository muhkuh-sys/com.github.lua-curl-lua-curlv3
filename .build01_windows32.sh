...
make
lua5.1 ${JONCHKI} --verbose info --syscfg ${PRJ_DIR}/jonchki/jonchkisys.cfg --prjcfg ${PRJ_DIR}/jonchki/jonchkicfg.xml --distribution-id windows --cpu-architecture x86 --build-dependencies lua-curlv3/lua5.1-curlv3-*.xml
popd
